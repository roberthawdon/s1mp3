...
static char *Mnemonics[256] =
{
  ...
  "RET P","POP AF","JP P,#h","DI","CALL P,#h","PUSH AF","OR *h","RST 30h  ;DEBUG API",
  "RET M","LD SP,HL","JP M,#h","EI","CALL M,#h","PFX_FD","CP *h","RST 38h  ;BREAKPOINT"
};
...
static char *MnemonicsXX[256] =
{
  ...
  "RET P","POP AF","JP P,#h","DI","CALL P,#h","PUSH AF","OR *h","RST 30h  ;DEBUG API",
  "RET M","LD SP,I%","JP M,#h","EI","CALL M,#h","PFX_FD","CP *h","RST 38h  ;BREAKPOINT"
};
