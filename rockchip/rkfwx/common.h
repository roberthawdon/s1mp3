#pragma once
  ...
  // -----------------------------------------------------------------------------------------------
  #define SET_COLOR(_color_) SetConsoleTextAttribute(GetStdHandle(STD_OUTPUT_HANDLE), _color_)  //set the text attribute of the standard output console
